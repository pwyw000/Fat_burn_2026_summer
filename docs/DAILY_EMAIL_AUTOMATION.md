...
| **今日计划 + 上传** | 计划 + `scripts/sync-and-mail.sh` 推 GitHub |
| **计划上传邮件** | **计划 + 上传 + 发邮件**（三步全做；推荐口令） |
...
- 引用 **Whoop 日常消耗 2,100 · 力量 +100 · 周赤字÷6**。  
- **Slow Carb：套用 `WEEK1_PLAN.md` §3.1（力量日 ~1,200）或 §3.2（跑日 ~1,800）**；禁止空泛建议。  
...
| 日类型 | 套用模板 | 目标 kcal |
|---|---|---:|
| 纯休 Slow Carb 日 | §3.1 再略减豆 | 1,050–1,200 |
| 力量日（Mon/Tue/Thu/Fri） | **§3.1** | 1,150–1,300（Whoop 日常 2100 + 力 100） |
| 跑步日（Sun/Wed） | **§3.2** | 1,700–1,900 |
...
## 4. 今日 Slow Carb 清单（[§3.1 力量日 ~1,200 / §3.2 跑日 ~1,800]）
...
1. **力量日**：默认复制 `WEEK1_PLAN.md` **§3.1**；主蛋白优先轮换 **虾 / 干贝·贝柱 / 鸡胸 / 鱼**。  
2. **跑步日**：默认复制 **§3.2**（含跑后香蕉+粉）；海鲜与鸡胸错开。  
