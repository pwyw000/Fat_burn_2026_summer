...
| 周一 | **力量 20 min 超级组** | **Shoulders + arms** · 午饭前优先 |
| 周二 | **力量 20 min 超级组** | **Chest + abs** · 午饭前优先 |
| 周三 | **跑步** | 周中跑 |
| 周四 | **力量 20 min 超级组** | **Back + rear delts** · 午饭前优先 |
| 周五 | **力量 20 min 超级组** | **Lower body** · 午饭前优先 |
...
|---|---|
| 有氧 | [跑 / 不跑] |
| 阻力 | [部位 · 20 min 超级组 · 午饭前 / 晚饭前] |
| 示例动作 | [当日 4 对超级组，见 WEEK1_PLAN §2] |
| 恢复 | [Whoop 颜色 + 睡眠] |
